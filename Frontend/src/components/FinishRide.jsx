...
<h3 className='text-2xl font-semibold mb-5'>Completed the ride</h3>
...
<Link to="/captain-home" className='w-[93%] flex justify-center bg-green-500 text-white font-semibold p-2 mt-5 rounded-lg'>Finish</Link>
